...
// FIX: Replace non-existent `EstatusPersonalConfig` with the correct unified `EstatusConfig` type.
import { EstatusConfig, Personal, EstatusPedido } from '../../lib/types';
import { EditIcon, DeleteIcon, PauseIcon, PlusIcon, SaveIcon, CancelIcon } from '../icons/Icons';

interface EstatusPersonalPageProps {
...
const EstatusPersonalPage: React.FC<EstatusPersonalPageProps> = ({ estatuses, setEstatuses, personal, setPersonal }) => {
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-8">
                <h3 className="text-gray-700 text-3xl font-medium">Estatus de Personal</h3>
                <button
...
export default EstatusPersonalPage;
